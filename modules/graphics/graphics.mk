...
graphics_test_depends_modules     = $(graphics_depends_modules)
...
graphics_test_libdepend_static_objs   += $(graphics_static_objects)
...
.PHONY: graphics_all
graphics_all: $(graphics_child_all_targets) ## build all graphics object files
graphics_all: $(graphics_static_objects)
...
graphics_test_run_all: graphics_test_all ## build and run graphics_test
