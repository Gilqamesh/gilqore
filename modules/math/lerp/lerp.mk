...
$(lerp_install_path_shared): $(lerp_depends_libs_shared) $(lerp_static_objects) $(lerp_shared_objects)
	$(CC) -o $@ $(LFLAGS_COMMON)  $(lerp_shared_lflags) $(lerp_shared_objects) $(lerp_depends_libs_shared)
