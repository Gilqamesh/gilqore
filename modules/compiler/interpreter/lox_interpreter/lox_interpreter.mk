...
lox_interpreter_depends_modules			:=  common
lox_interpreter_test_depends_modules     := lox_interpreter test_framework libc common compare process file time system random file_reader hash circular_buffer mod memory 
