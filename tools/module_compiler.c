...
int main() {
    ...
    struct module* common = &g_modules[g_modules_size++]; module_add_child(pm, common, "common");
    struct module* io = &g_modules[g_modules_size++]; module_add_child(pm, io, "io");
    struct module* libc = &g_modules[g_modules_size++]; module_add_child(pm, libc, "libc");
    struct module* data_structures = &g_modules[g_modules_size++]; module_add_child(pm, data_structures, "data_structures");
    struct module* graphics = &g_modules[g_modules_size++]; module_add_child(pm, graphics, "graphics");

    struct module* file = &g_modules[g_modules_size++]; module_add_child(io, file, "file");
    struct module* directory = &g_modules[g_modules_size++]; module_add_child(io, directory, "directory");
    struct module* console = &g_modules[g_modules_size++]; module_add_child(io, console, "console");

    struct module* color = &g_modules[g_modules_size++]; module_add_child(graphics, color, "color");
    struct module* renderer = &g_modules[g_modules_size++]; module_add_child(graphics, renderer, "renderer");
    struct module* window = &g_modules[g_modules_size++]; module_add_child(graphics, window, "window");

    struct module* file_reader = &g_modules[g_modules_size++]; module_add_child(file, file_reader, "file_reader");
    struct module* riff_loader = &g_modules[g_modules_size++]; module_add_child(file, riff_loader, "riff_loader");

    struct module* wav_parser = &g_modules[g_modules_size++]; module_add_child(riff_loader, wav_parser, "wav_parser");

    struct module* circular_buffer = &g_modules[g_modules_size++]; module_add_child(data_structures, circular_buffer, "circular_buffer");
