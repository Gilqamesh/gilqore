...
lox_interpreter_depends_modules			:= lox_parser libc common compare parser memory basic_types gil_math hash lox_tokenizer time system  common
lox_interpreter_test_depends_modules     := lox_interpreter lox_parser libc common compare parser memory basic_types gil_math hash lox_tokenizer time system test_framework process file random file_reader circular_buffer mod 
