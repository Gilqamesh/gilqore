...
types_test_depends_modules     := types test_framework libc common process file time system random compare file_reader hash circular_buffer mod 
...
.PHONY: types_all
types_all: $(types_static_objects) ## build all types object files

.PHONY: types_test_all
types_test_all: $(types_test_install_path_static) ## build types_test test
...
types_test_run_all: $(types_test_child_all_targets) ## build and run types_test
