...
lox_parser_depends_modules			:= libc common compare parser memory basic_types gil_math hash  common
lox_parser_test_depends_modules     := lox_parser libc common compare parser memory basic_types gil_math hash test_framework process file time system random file_reader circular_buffer mod 
