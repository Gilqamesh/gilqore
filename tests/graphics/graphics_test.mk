...
graphics_test_depends_modules			        :=  graphics test_framework
...
graphics_test_run: graphics_test_all ## build and run static graphics_test
graphics_test_run: $(graphics_test_child_run_targets)
ifneq ($(graphics_test_objects),)
graphics_test_run:
