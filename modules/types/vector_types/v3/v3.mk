...
.PHONY: v3_all
v3_all: $(v3_static_objects) ## build all v3 object files

.PHONY: v3_test_all
v3_test_all: $(v3_test_install_path_static) ## build v3_test test
...
v3_test_run_all: $(v3_test_child_all_targets) ## build and run v3_test
