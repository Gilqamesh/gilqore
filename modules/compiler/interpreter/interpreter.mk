...
interpreter_depends_modules			:= libc common compare file time system random console memory tokenizer lox_tokenizer c_tokenizer comment_tokenizer parser lox_parser  common
interpreter_test_depends_modules     := interpreter libc common compare file time system random console memory tokenizer lox_tokenizer c_tokenizer comment_tokenizer parser lox_parser test_framework process file_reader hash circular_buffer mod 
