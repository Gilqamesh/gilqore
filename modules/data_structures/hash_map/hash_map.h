...
PUBLIC_API hash_map_key_t* hash_map__insert(hash_map_t* self, const hash_map_key_t* key, const hash_map_value_t* value);
PUBLIC_API bool hash_map__remove(hash_map_t* self, const hash_map_key_t* key);
PUBLIC_API void hash_map__clear(hash_map_t* self);
PUBLIC_API hash_map_value_t* hash_map__find(hash_map_t* self, const hash_map_key_t* key);
