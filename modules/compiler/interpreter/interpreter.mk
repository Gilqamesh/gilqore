...
interpreter_depends_modules			:= libc common compare file time system random console memory tokenizer lox_tokenizer comment_tokenizer parser lox_parser basic_types gil_math hash lox_interpreter  common
interpreter_test_depends_modules     := interpreter libc common compare file time system random console memory tokenizer lox_tokenizer comment_tokenizer parser lox_parser basic_types gil_math hash lox_interpreter test_framework process file_reader circular_buffer mod 
