...
comment_tokenizer_test_depends_modules     := comment_tokenizer test_framework libc common compare process file time system memory random file_reader hash circular_buffer mod abs 
