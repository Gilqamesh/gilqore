...
string_replacer_depends_modules			:= libc common compare file time system memory random hash v2 sqrt abs clamp v3 v4 gil_math linear_allocator  common
string_replacer_test_depends_modules     := string_replacer libc common compare file time system memory random hash v2 sqrt abs clamp v3 v4 gil_math linear_allocator test_framework process file_reader circular_buffer mod 
