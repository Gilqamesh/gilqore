...
libc_test_depends_libs         := $(foreach module,$(libc_test_depends_modules),$(PATH_INSTALL)/$(module)$(EXT))
...
$(libc_test_install_path): $(libc_test_objects)
	$(CC) -o $@ $^ $(libc_test_depends_libs)

.PHONY: libc_test_all
libc_test_all: $(libc_test_install_path) ## build all libc_test tests

.PHONY: libc_test_clean
libc_test_clean: ## remove all libc_test tests
