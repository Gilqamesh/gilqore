...
clamp_sources					+= $(wildcard $(clamp_path_curdir)platform_non_specific/*.c)
ifeq ($(PLATFORM), WINDOWS)
...
clamp_test_depends_modules     := clamp v2 sqrt abs v3 v4 test_framework libc common compare process file time system random file_reader hash circular_buffer mod memory 
