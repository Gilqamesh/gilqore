...
$(tools_install_path_shared): $(tools_depends_libs_shared) $(tools_static_objects) $(tools_shared_objects)
	$(CC) -o $@ $(LFLAGS_COMMON)  $(tools_shared_lflags) $(tools_shared_objects) $(tools_depends_libs_shared)
