...
test_framework_depends_modules			:= libc common compare process file time system memory random file_reader hash circular_buffer mod abs  common
test_framework_test_depends_modules     := test_framework libc common compare process file time system memory random file_reader hash circular_buffer mod abs 
