...
compare_test_libdepend_target     := $(compare_test_name_curdir)_all $(foreach module,$(compare_test_depends_modules),$(module)_all) test_framework_all
compare_test_libdepend_static     := $(PATH_INSTALL)/$(compare_test_name_curdir)$(EXT_LIB_STATIC)
compare_test_libdepend_static     += $(foreach module_base,$(compare_test_depends_modules),$(PATH_INSTALL)/$(module_base)$(EXT_LIB_STATIC))
compare_test_libdepend_shared     := $(PATH_INSTALL)/lib$(compare_test_name_curdir)dll.a $(PATH_INSTALL)/libtest_frameworkdll.a
compare_test_libdepend_shared     += $(foreach module_base,$(compare_test_depends_modules),$(PATH_INSTALL)/lib$(module_base)dll.a)
...
$(compare_test_install_path_shared): $(compare_test_objects)
