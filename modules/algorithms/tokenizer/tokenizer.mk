...
tokenizer_test_depends_modules     := tokenizer memory file common time system libc compare random test_framework process file_reader hash circular_buffer mod 
