...
console_sources					+= $(wildcard $(console_path_curdir)platform_non_specific/*.c)
ifeq ($(PLATFORM), WINDOWS)
...
console_test_depends_modules     := console libc common compare test_framework process file time system memory random file_reader hash circular_buffer mod abs 
