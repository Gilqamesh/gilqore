...
time_depends_modules			:= common system 
time_test_depends_modules     := time test_framework libc common process file random compare file_reader hash circular_buffer mod 
...
.PHONY: time_all
time_all: $(time_static_objects) ## build all time object files

.PHONY: time_test_all
time_test_all: $(time_test_install_path_static) ## build time_test test
...
time_test_run_all: $(time_test_child_all_targets) ## build and run time_test
