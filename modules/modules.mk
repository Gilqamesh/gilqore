...
modules_depends_modules			:= file common time system memory libc compare random file_reader hash circular_buffer mod abs file_writer string directory string_replacer v2 sqrt clamp v3 v4 gil_math linear_allocator file_path stack thread  common
modules_test_depends_modules     := modules file common time system memory libc compare random file_reader hash circular_buffer mod abs file_writer string directory string_replacer v2 sqrt clamp v3 v4 gil_math linear_allocator file_path stack thread test_framework process 
