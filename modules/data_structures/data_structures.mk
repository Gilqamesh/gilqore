...
data_structures_test_depends_modules     = $(data_structures_depends_modules)
...
data_structures_test_libdepend_static_objs   += $(data_structures_static_objects)
...
data_structures_all: $(data_structures_child_all_targets) ## build all data_structures object files
data_structures_all: $(data_structures_static_objects)
...
data_structures_test_run_all: data_structures_test_all ## build and run data_structures_test
