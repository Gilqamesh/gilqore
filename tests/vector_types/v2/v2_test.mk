...
v2_test_libdepend_target     := $(v2_test_name_curdir)_all test_framework_all
...
$(v2_test_install_path_static): $(v2_test_objects) $(v2_test_libdepend_static) $(PATH_INSTALL)/test_framework.lib
...
$(v2_test_install_path_shared): $(v2_test_objects) $(v2_test_libdepend_shared)
