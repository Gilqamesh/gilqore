...
tools_test_depends_modules			        :=  tools test_framework
tools_test_libdepend_static_objs	        := $(foreach dep_module,$(tools_depends_modules),$($(dep_module)_static_objects))
tools_test_libdepend_static_objs	        += $(foreach dep_module,$(foreach m,$(tools_test_depends_modules),$($(m)_depends_modules)),$($(dep_module)_static_objects))
...
$(tools_test_install_path_static): $(tools_test_libdepend_static_objs)
$(tools_test_install_path_static): $(tools_test_objects)
...
tools_test_run: tools_test_all ## build and run static tools_test
tools_test_run: $(tools_test_child_run_targets)
ifneq ($(tools_test_objects),)
tools_test_run:
