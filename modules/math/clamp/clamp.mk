...
clamp_test_depends_modules     := clamp test_framework libc common process file time system random compare file_reader hash circular_buffer mod memory v2 sqrt abs v3 v4 
