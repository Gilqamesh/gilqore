...
random_test_libdepend_target     := $(random_test_name_curdir)_all test_framework_all
...
$(random_test_install_path_static): $(random_test_objects) $(random_test_libdepend_static) $(PATH_INSTALL)/test_framework.lib
...
$(random_test_install_path_shared): $(random_test_objects) $(random_test_libdepend_shared)
