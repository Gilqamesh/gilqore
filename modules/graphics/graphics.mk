...
$(graphics_install_path_shared): $(graphics_depends_libs_shared) $(graphics_static_objects) $(graphics_shared_objects)
	$(CC) -o $@ $(LFLAGS_COMMON)  $(graphics_shared_lflags) $(graphics_shared_objects) $(graphics_depends_libs_shared)
