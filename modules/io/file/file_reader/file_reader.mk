...
file_reader_depends_modules			:= hash libc common compare circular_buffer mod memory file time system random abs  common
file_reader_test_depends_modules     := file_reader hash libc common compare circular_buffer mod memory file time system random abs test_framework process 
