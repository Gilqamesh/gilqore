...
sqrt_test_depends_modules     = $(sqrt_depends_modules)
...
sqrt_test_libdepend_static_objs   += $(sqrt_static_objects)
sqrt_clean_files				:=
...
.PHONY: sqrt_all
sqrt_all: $(sqrt_child_all_targets) ## build all sqrt object files
sqrt_all: $(sqrt_static_objects)
...
sqrt_test_run_all: sqrt_test_all ## build and run sqrt_test
