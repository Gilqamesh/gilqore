...
lox_interpreter_test_depends_modules     := lox_interpreter lox_parser libc common compare parser memory basic_types gil_math lox_tokenizer time system hash test_framework process file random file_reader circular_buffer mod abs 
