...
PUBLIC_API bool process__create(struct process* self, const char* path);
...
PUBLIC_API u32 process__destroy(struct process* self);

// @brief wait until the process has stopped execution
PUBLIC_API void process__wait_execution(struct process* self);
...
PUBLIC_API void process__wait_timeout(struct process* self, u32 milliseconds);
