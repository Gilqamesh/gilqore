...
lerp_test_libdepend_target     := $(lerp_test_name_curdir)_all test_framework_all
...
$(lerp_test_install_path_static): $(lerp_test_objects) $(lerp_test_libdepend_static) $(PATH_INSTALL)/test_framework.lib
...
$(lerp_test_install_path_shared): $(lerp_test_objects) $(lerp_test_libdepend_shared)
