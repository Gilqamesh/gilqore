...
tokenizer_depends_modules			:=  common
tokenizer_test_depends_modules     := tokenizer test_framework libc common compare process file time system random file_reader hash circular_buffer mod memory 
