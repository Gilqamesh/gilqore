...
time_sources					+= $(wildcard $(time_path_curdir)platform_non_specific/*.c)
ifeq ($(PLATFORM), WINDOWS)
...
time_depends_modules			:= common system memory libc compare  common
time_test_depends_modules     := time common system memory libc compare test_framework process file random file_reader hash circular_buffer mod abs 
