...
file_reader_test_install_path_static := $(file_reader_path_curtestdir)file_reader_static$(EXT_EXE)
endif
...
file_reader_test_depends_modules     := file_reader test_framework libc common process file time system random compare 
...
$(file_reader_test_install_path_static): $(file_reader_test_objects) $(file_reader_test_libdepend_static_objs)
...
file_reader_all: $(file_reader_static_objects) ## build all file_reader object files

.PHONY: file_reader_test_all
file_reader_test_all: $(file_reader_test_install_path_static) ## build file_reader_test test
...
file_reader_test_run_all: $(file_reader_test_child_all_targets) ## build and run file_reader_test
