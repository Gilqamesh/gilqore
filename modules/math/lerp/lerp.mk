...
lerp_test_depends_modules     := lerp test_framework libc common process file time system random compare file_reader hash circular_buffer mod 
...
.PHONY: lerp_all
lerp_all: $(lerp_static_objects) ## build all lerp object files

.PHONY: lerp_test_all
lerp_test_all: $(lerp_test_install_path_static) ## build lerp_test test
...
lerp_test_run_all: $(lerp_test_child_all_targets) ## build and run lerp_test
