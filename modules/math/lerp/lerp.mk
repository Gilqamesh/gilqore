...
lerp_test_depends_modules     := lerp test_framework libc common process file time system random compare file_reader hash circular_buffer mod memory color v4 
