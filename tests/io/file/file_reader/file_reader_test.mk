...
file_reader_test_depends_modules			        := libc random common mod file_reader test_framework
...
file_reader_test_run: file_reader_test_all ## build and run static file_reader_test
file_reader_test_run: $(file_reader_test_child_run_targets)
ifneq ($(file_reader_test_objects),)
file_reader_test_run:
