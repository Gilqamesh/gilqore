...
segment_allocator_depends_modules			:= libc common compare memory  common
segment_allocator_test_depends_modules     := segment_allocator libc common compare memory test_framework process file time system random file_reader hash circular_buffer mod abs 
