...
$(mod_install_path_shared): $(mod_depends_libs_shared) $(mod_static_objects) $(mod_shared_objects)
	$(CC) -o $@ $(LFLAGS_COMMON)  $(mod_shared_lflags) $(mod_shared_objects) $(mod_depends_libs_shared)
