...
interpreter_depends_modules			:= libc common compare file time system random console memory tokenizer lox_tokenizer c_tokenizer comment_tokenizer  common
interpreter_test_depends_modules     := interpreter libc common compare file time system random console memory tokenizer lox_tokenizer c_tokenizer comment_tokenizer test_framework process file_reader hash circular_buffer mod 
