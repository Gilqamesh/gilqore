...
directory_test_depends_modules     := directory common libc compare file time system memory random test_framework process file_reader hash circular_buffer mod 
