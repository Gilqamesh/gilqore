...
process_depends_modules			:= file common time system memory libc compare random  common
process_test_depends_modules     := process file common time system memory libc compare random test_framework file_reader hash circular_buffer mod abs 
