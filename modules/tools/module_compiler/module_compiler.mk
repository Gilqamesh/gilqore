...
module_compiler_depends_modules			:= file common time libc file_reader hash compare circular_buffer mod file_writer string directory string_replacer file_path 
