...
lox_parser_depends_modules			:= libc common compare parser memory basic_types gil_math  common
lox_parser_test_depends_modules     := lox_parser libc common compare parser memory basic_types gil_math test_framework process file time system random file_reader hash circular_buffer mod abs 
