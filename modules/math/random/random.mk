...
random_test_install_path_static := $(random_path_curtestdir)random_static$(EXT_EXE)
endif
...
$(random_test_install_path_static): $(random_test_objects) $(random_test_libdepend_static_objs)
