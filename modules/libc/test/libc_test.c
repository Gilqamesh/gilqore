...
static void test_itoa(char* buffer, u32 buffer_size, s64 n, u32 radix, const char* expected) {
    libc__itoa(n, buffer, buffer_size, radix);
...
int main() {
    char buffer[64];
    test_itoa(buffer, ARRAY_SIZE(buffer), 2321, 10, "2321");
    test_itoa(buffer, ARRAY_SIZE(buffer), 0, 10, "0");
    test_itoa(buffer, ARRAY_SIZE(buffer), -1, 10, "-1");
    test_itoa(buffer, ARRAY_SIZE(buffer), S64_MIN, 10, "-9223372036854775808");
    test_itoa(buffer, ARRAY_SIZE(buffer), 2321, 16, "911");
    test_itoa(buffer, ARRAY_SIZE(buffer), 0, 16, "0");
    test_itoa(buffer, ARRAY_SIZE(buffer), -1, 16, "-1");
    test_itoa(buffer, ARRAY_SIZE(buffer), S64_MIN, 16, "-8000000000000000");
