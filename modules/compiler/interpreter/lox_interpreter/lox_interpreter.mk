...
lox_interpreter_depends_modules			:= lox_parser libc common compare parser memory basic_types gil_math hash lox_tokenizer  common
lox_interpreter_test_depends_modules     := lox_interpreter lox_parser libc common compare parser memory basic_types gil_math hash lox_tokenizer test_framework process file time system random file_reader circular_buffer mod 
