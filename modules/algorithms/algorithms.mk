...
algorithms_test_depends_modules     := algorithms test_framework libc common compare process file time system memory random file_reader hash circular_buffer mod abs 
