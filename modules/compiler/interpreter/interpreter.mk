...
interpreter_depends_modules			:= libc common compare file time system random console  common
interpreter_test_depends_modules     := interpreter libc common compare file time system random console test_framework process file_reader hash circular_buffer mod memory 
