...
system_test_depends_modules     := system common test_framework libc compare process file time memory random file_reader hash circular_buffer mod abs 
...
$(system_test_install_path): $(system_test_objects) $(system_test_libdepend_objs)
	$(CC) -o $@ $(system_test_objects) $(system_test_libdepend_objs) $(LFLAGS_COMMON) -mconsole
...
system_test_run_all: $(TEST_FRAMEWORK_EXE)
	@$(TEST_FRAMEWORK_EXE) $(system_test_install_path)
endif
...
ifneq ($(system_test_objects),)
system_test_run: $(TEST_FRAMEWORK_EXE)
	@$(TEST_FRAMEWORK_EXE) $(system_test_install_path)
endif
