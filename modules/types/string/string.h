...
PUBLIC_API char* string__search_n         (const char* str, const char* set, u32 n, bool return_last_occurance);
// @brief increments 'str' 'max' amount while it matches either characters from 'set'
PUBLIC_API char* string__search_while     (const char* str, const char* set, u32 max);
// @brief increments 'str' 'max' amount while it does not match either characters from 'set'
PUBLIC_API char* string__search_while_not (const char* str, const char* set, u32 max);
