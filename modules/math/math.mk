...
math_sources					+= $(wildcard $(math_path_curdir)platform_non_specific/*.c)
ifeq ($(PLATFORM), WINDOWS)
...
math_test_depends_modules     := math test_framework libc common process file time system random compare file_reader hash circular_buffer mod memory 
