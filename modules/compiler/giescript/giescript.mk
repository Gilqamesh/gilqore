...
giescript_depends_modules			:= libc common compare segment_allocator memory console hash basic_types gil_math  common
giescript_test_depends_modules     := giescript libc common compare segment_allocator memory console hash basic_types gil_math test_framework process file time system random file_reader circular_buffer mod abs 
