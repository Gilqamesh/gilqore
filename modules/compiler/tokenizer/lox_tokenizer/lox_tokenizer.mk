...
lox_tokenizer_depends_modules			:=  common
lox_tokenizer_test_depends_modules     := lox_tokenizer test_framework libc common compare process file time system random file_reader hash circular_buffer mod memory 
