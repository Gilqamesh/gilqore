...
string_replacer_test_depends_modules     := string_replacer test_framework libc common process file time system random compare file_reader hash circular_buffer mod v2 sqrt abs clamp v3 v4 math linear_allocator memory 
