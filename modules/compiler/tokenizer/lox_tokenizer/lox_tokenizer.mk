...
lox_tokenizer_test_depends_modules     := lox_tokenizer libc common compare test_framework process file time system memory random file_reader hash circular_buffer mod abs 
