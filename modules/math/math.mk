...
$(math_install_path_shared): $(math_depends_libs_shared) $(math_static_objects) $(math_shared_objects)
	$(CC) -o $@ $(LFLAGS_COMMON)  $(math_shared_lflags) $(math_shared_objects) $(math_depends_libs_shared)
