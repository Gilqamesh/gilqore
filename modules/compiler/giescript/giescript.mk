...
giescript_depends_modules			:= libc common compare memory  common
giescript_test_depends_modules     := giescript libc common compare memory test_framework process file time system random file_reader hash circular_buffer mod 
