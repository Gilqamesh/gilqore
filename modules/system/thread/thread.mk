...
thread_sources					+= $(wildcard $(thread_path_curdir)platform_non_specific/*.c)
ifeq ($(PLATFORM), WINDOWS)
...
thread_test_depends_modules     := thread libc common compare random test_framework process file time system memory file_reader hash circular_buffer mod abs 
