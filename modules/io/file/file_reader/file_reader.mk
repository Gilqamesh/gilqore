...
file_reader_test_depends_modules     = $(file_reader_depends_modules)
...
file_reader_test_libdepend_static_objs   += $(file_reader_static_objects)
...
file_reader_all: $(file_reader_child_all_targets) ## build all file_reader object files
file_reader_all: $(file_reader_static_objects)
...
file_reader_test_run_all: file_reader_test_all ## build and run file_reader_test
