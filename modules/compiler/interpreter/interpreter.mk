...
interpreter_test_depends_modules     := interpreter libc common compare file time system memory random console tokenizer lox_tokenizer comment_tokenizer parser lox_parser basic_types gil_math lox_interpreter hash test_framework process file_reader circular_buffer mod 
