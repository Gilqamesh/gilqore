...
file_writer_test_depends_modules			        :=  file_writer test_framework
...
file_writer_test_run: file_writer_test_all ## build and run static file_writer_test
file_writer_test_run: $(file_writer_test_child_run_targets)
ifneq ($(file_writer_test_objects),)
file_writer_test_run:
